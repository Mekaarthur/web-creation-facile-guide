    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="general" className="w-full">
        <TabsList>
          ...
          <TabsTrigger value="client_rules">
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configuration des critères d'inscription et de gestion des comptes clients
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configuration des critères de réservation des prestations
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      id="preauthorization_at_booking"
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configuration des frais et délais d'annulation
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="modification_deadline_hours"
                      type="number"
                      min="1"
                      max="48"

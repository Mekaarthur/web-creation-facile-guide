  ...
  pro: {
    ...
    subservices: [
      ...
      },
      {
        ...
        description: "Entretien complet de vos bureaux de 100 à 200m² — espaces de travail, parties communes et sanitaires",
        financialCategory: "bika_entreprise",
        urssaf_eligible: false,
        isForfait: false,
      },
      {
        ...
        image: serviceBusinessAdmin,
        description: "Fourniture de produits ménagers professionnels pour chaque intervention",
        financialCategory: "bika_entreprise",
        urssaf_eligible: false,
        isForfait: true,
      },

...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description: 'Payez en ligne en toute sécurité. Bénéficiez du crédit d\'impôt 50% : récupérez la moitié de vos dépenses lors de votre déclaration fiscale annuelle.',
    },
  ];

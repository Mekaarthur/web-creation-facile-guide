...
- **R-SEL-04** : Indisponibilité — si `useProviderZoneCheck` retourne `count = 0`, bloquer le bouton "Ajouter au panier" et afficher : "Service disponible prochainement dans votre secteur". Ne jamais permettre un paiement sans prestataire disponible dans la zone. Message avec numéro de contact : 06 09 08 53 90.

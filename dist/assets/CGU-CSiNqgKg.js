import{Y as e}from"./ui-If8Ec90q.js";import{V as r,a6 as o,S as l,j as i,k as n,ah as u}from"./index-Dsmueuj-.js";import{F as d}from"./Footer-BcepSW3u.js";import{A as c,b as m,c as p,a as f}from"./accordion-Df7WVIGR.js";import"./router-C76W1hu5.js";const x=()=>{const a="20/01/2026",s=[{id:"definitions",title:"1. Définitions",content:`Les définitions ci-dessous s'appliquent à l'ensemble des présentes CGU :
...
Sauf exigence contraire résultant du contexte, les termes définis au singulier incluent le pluriel, et inversement.`},{id:"objet",title:"2. Objet et portée des CGU",content:`Bikawo exploite la Plateforme, un service numérique de mise en relation permettant aux Partenaires d'être mis en relation avec des Clients afin que ces derniers bénéficient de Prestations.
...
Les présentes CGU s'appliquent à toute utilisation de la Plateforme opérée par Bikawo.`},{id:"inscription-client",title:"3. Inscription et acceptation des CGU",content:`3.1. Pour le Client
...
Après acceptation, le Partenaire reçoit un email confirmant la création du Compte, incluant une copie PDF des CGU acceptées.`},{id:"conditions-partenaires",title:"4. Conditions d'inscription spécifiques aux Partenaires",content:`Afin de finaliser la création du Compte et de pouvoir réaliser des Prestations, le Partenaire doit :
...
L'activation et le maintien du Compte sont conditionnés à la fourniture et à la mise à jour régulière des justificatifs requis.`},{id:"evolution-services",title:"5. Évolution des Services et modification des CGU",content:`Afin d'améliorer son fonctionnement et la qualité des Services, Bikawo peut faire évoluer les caractéristiques et fonctionnalités de la Plateforme.
...
En cas de perte, vol, détournement, compromission des identifiants ou d'utilisation non autorisée du Compte, l'Utilisateur doit en informer immédiatement Bikawo. Dans une telle situation, l'Utilisateur autorise Bikawo à prendre toutes mesures appropriées afin d'empêcher tout accès non autorisé.`},{id:"realisation-prestations",title:"7. Réalisation des Prestations",content:`7.1. Commande
...
Le Partenaire demeure seul responsable, notamment des produits utilisés, de son apparence et de son comportement. À l'issue d'une Prestation, le Client peut évaluer la Prestation via un système de notation. Les évaluations ont vocation à être définitives et ne sont supprimées qu'exceptionnellement, sur demande expresse de leur auteur.`},{id:"conditions-financieres",title:"8. Conditions financières",content:`8.1. Prix des Prestations
...
• disposer de fonds suffisants pour payer la Prestation.`},{id:"engagements-bikawo",title:"9. Engagements de Bikawo",content:`Bikawo s'engage à mettre la Plateforme et les Services à disposition des Utilisateurs et à faire ses meilleurs efforts pour en assurer l'accessibilité et le bon fonctionnement.
...
En cas d'anomalie ou de dysfonctionnement, Bikawo s'engage à mettre en œuvre ses meilleurs efforts pour rétablir le service.`},{id:"responsabilite-bikawo",title:"10. Responsabilité de Bikawo",content:`Les Utilisateurs reconnaissent que la responsabilité de Bikawo est strictement limitée à son rôle d'opérateur de plateforme en ligne.
...
En tout état de cause, si la responsabilité de Bikawo était engagée, elle est limitée aux dommages certains, directs et prévisibles, et l'indemnisation est plafonnée au coût effectivement supporté par l'Utilisateur.`},{id:"engagements-utilisateurs",title:"11. Engagements des Utilisateurs",content:`11.1. Engagements communs
...
• respecter la réglementation applicable aux services à la personne.`},{id:"responsabilite-utilisateurs",title:"12. Responsabilité des Utilisateurs",content:`L'Utilisateur est responsable de l'usage qu'il fait de la Plateforme et des Services, ainsi que des dommages résultant de son comportement ou d'informations inexactes, incomplètes ou trompeuses fournies lors de l'inscription ou en cas de non-mise à jour.

Plus spécifiquement, les Utilisateurs sont responsables :
• des informations publiées via leur Compte ;
• de la négociation, conclusion et exécution de leurs contrats de prestation, Bikawo n'étant qu'un intermédiaire de mise en relation.`},{id:"duree-resiliation",title:"13. Durée, suspension et résiliation",content:`13.1. Durée
...
• Résiliation par Bikawo : avec un préavis dépendant de l'ancienneté (aucun préavis si moins de 3 mois, 7 jours entre 3 et 6 mois, 15 jours entre 6 mois et 1 an, 1 mois entre 1 et 2 ans, 2 mois au-delà).`},{id:"obligations-fiscales",title:"14. Respect des obligations fiscales et sociales",content:`Le Partenaire est informé que son activité génère des obligations légales, fiscales, sociales administratives dont il doit s'acquitter. Il demeure seul responsable des déclarations et formalités, notamment du paiement des cotisations et contributions sociales.

Le Partenaire est invité à consulter :
• impôts : https://www.impots.gouv.fr/portail/node/10841`},{id:"autonomie",title:"15. Autonomie et indépendance",content:`Bikawo et le Partenaire exercent en autonomie totale, chacun supportant les risques liés à son activité.
...
Le Partenaire est informé qu'il peut bénéficier du soutien de Bikawo au titre de la responsabilité sociale de plateforme (articles L.7342-1 et suivants du Code du travail).`},{id:"indemnisation",title:"16. Indemnisation",content:`Bikawo n'étant pas partie au contrat Client/Partenaire, elle n'est pas responsable des dommages pouvant survenir lors de l'exécution d'une commande.
...
Exclusions : vol, œuvres d'art, rayures/taches n'empêchant pas l'usage, prestations hors Plateforme.`},{id:"propriete-intellectuelle",title:"17. Propriété intellectuelle",content:`La Plateforme, le Site et l'ensemble de leurs éléments (logiciels, infrastructures, bases de données, contenus, textes, images, logos, marques…) sont protégés par les droits de propriété intellectuelle.

L'utilisateur reconnaît que ces éléments sont la propriété exclusive de Bikawo ou de ses partenaires et s'engage à ne pas les reproduire, modifier, distribuer ou exploiter de quelque manière que ce soit sans autorisation préalable écrite.`},{id:"donnees-personnelles",title:"18. Données personnelles",content:`Bikawo attache une importance particulière à la protection des données personnelles et au respect du RGPD (Règlement (UE) 2016/679).

Pour plus d'informations sur la collecte, le traitement et la protection de vos données personnelles, veuillez consulter notre Politique de Confidentialité.`},{id:"litiges",title:"19. Règlement des différends et médiation",content:`En cas de litige entre un Utilisateur et Bikawo, les parties s'engagent à rechercher une solution amiable.
...
Conformément au règlement UE n°524/2013, vous pouvez également soumettre votre litige via : https://ec.europa.eu/consumers/odr/`},{id:"divers",title:"20. Divers",content:`Les CGU remplacent tout accord antérieur.

Si une clause est nulle, les autres demeurent applicables.

Le fait de ne pas exercer un droit n'emporte pas renonciation.`},{id:"loi-applicable",title:"21. Loi applicable – Juridiction compétente",content:`Les CGU sont régies par le droit français.
...
Conformément à l'article R.631-3 du Code de la consommation, le consommateur peut saisir, à son choix, la juridiction du lieu où il demeurait lors de la conclusion du contrat ou lors de la survenance du fait dommageable, outre les règles de compétence de droit commun.`},{id:"retractation",title:"22. Formulaire de rétractation",content:`Si vous souhaitez vous rétracter d'une prestation commandée, veuillez remplir ce formulaire et l'adresser à Bikawo par courrier ou par email à contact@bikawo.com.
...
(*) Rayez la mention inutile.`}];return e.jsxs("div",{className:"min-h-screen bg-background",children:[e.jsxs(r,{children:[e.jsx("title",{children:"Conditions Générales d'Utilisation | Bikawo"}),e.jsx("meta",{name:"description",content:"Conditions Générales d'Utilisation de la plateforme Bikawo - Services à la personne"})]}),e.jsx(o,{}),e.jsx("main",{className:"pt-16 lg:pt-20 pb-16",children:e.jsxs("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8",children:[e.jsxs("div",{className:"text-center mb-12",children:[e.jsx("div",{className:"inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 mb-6",children:e.jsx(l,{className:"w-8 h-8 text-primary"})}),e.jsx("h1",{className:"text-3xl md:text-4xl font-bold text-foreground mb-4",children:"Conditions Générales d'Utilisation"}),e.jsxs("p",{className:"text-muted-foreground",children:["Dernière mise à jour : ",a]})]}),e.jsx(i,{className:"mb-8 border-primary/20 bg-primary/5",children:e.jsx(n,{className:"p-6",children:e.jsxs("div",{className:"flex items-start gap-4",children:[e.jsx(u,{className:"w-6 h-6 text-primary flex-shrink-0 mt-1"}),e.jsxs("div",{children:[e.jsx("h2",{className:"font-semibold text-foreground mb-2",children:"Bienvenue sur Bikawo"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Les présentes Conditions Générales d'Utilisation (CGU) régissent l'utilisation de la plateforme Bikawo, un service numérique de mise en relation entre Clients et Partenaires pour des prestations de services à la personne. En utilisant notre plateforme, vous acceptez ces conditions dans leur intégralité."})]})]})})}),e.jsx(c,{type:"single",collapsible:!0,className:"space-y-4",children:s.map(t=>e.jsxs(m,{value:t.id,className:"border rounded-lg px-4 bg-card",children:[e.jsx(p,{className:"text-left hover:no-underline py-4",children:e.jsx("span",{className:"font-semibold text-foreground",children:t.title})}),e.jsx(f,{className:"pb-4",children:e.jsx("div",{className:"prose prose-sm max-w-none text-muted-foreground whitespace-pre-line",children:t.content})})]},t.id))}),e.jsx(i,{className:"mt-12",children:e.jsxs(n,{className:"p-6",children:[e.jsx("h3",{className:"font-semibold text-foreground mb-4",children:"Contact"}),e.jsxs("div",{className:"text-sm text-muted-foreground space-y-2",children:[e.jsx("p",{children:e.jsx("strong",{children:"Bikawo"})}),e.jsx("p",{children:"231 rue Saint-Honoré, 75001 Paris"}),e.jsx("p",{children:"Email : contact@bikawo.com"}),e.jsx("p",{children:"N° INPI : 880 491 436"})]})]})})]})}),e.jsx(d,{})]})};export{x as default};

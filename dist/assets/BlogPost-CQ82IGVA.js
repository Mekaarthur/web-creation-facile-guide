import{Y as e}from"./ui-If8Ec90q.js";import{h as a,j as d,L as t}from"./router-C76W1hu5.js";import{p as h}from"./purify.es-B_J904Nm.js";import{a6 as o,i as l,b as g,B as v,w as f,ax as x,C as b,j}from"./index-Dsmueuj-.js";import{F as u}from"./Footer-BcepSW3u.js";import{S as c}from"./SEOComponent-BW-B-vQ6.js";import{g as C}from"./seoData-Bv3d60hX.js";import{S as q}from"./share-2-DqLAg1Sc.js";import{B as z}from"./book-open-DhahX9SY.js";const P=()=>{const[s,i]=a.useState(0);return a.useEffect(()=>{const n=()=>{const p=window.scrollY,r=document.documentElement.scrollHeight-window.innerHeight,m=r>0?p/r*100:0;i(Math.min(100,Math.max(0,m)))};return window.addEventListener("scroll",n,{passive:!0}),n(),()=>window.removeEventListener("scroll",n)},[]),e.jsxs("div",{className:"fixed top-0 left-0 right-0 z-50 h-1 bg-muted",children:[e.jsx("div",{className:"h-full bg-primary transition-all duration-150 ease-out",style:{width:`${s}%`}}),s>0&&e.jsxs("div",{className:"absolute right-2 top-2 bg-background/90 backdrop-blur-sm rounded-full px-2 py-0.5 text-xs font-medium text-muted-foreground border border-border/50 shadow-sm",children:[Math.round(s),"%"]})]})},A={"10-signes-charge-mentale":{title:"10 signes que vous souffrez de charge mentale",category:"Bien-être",readTime:"8 min",publishedAt:"2024-01-15",author:"Dr. Marie Dubois",image:"/lovable-uploads/89199702-071c-4c4a-9b41-72fb5742cbee.png",content:`
    ...
    `},"guide-deleguer-sans-culpabiliser":{title:"Guide complet pour déléguer sans culpabiliser",category:"Organisation",readTime:"12 min",publishedAt:"2024-01-10",author:"Sophie Martin",image:"/lovable-uploads/7289c795-0ba4-4e3f-86dc-cd0e3310a306.png",content:`
    ...
    `},"cout-aide-menagere-vs-temps":{title:"Coût réel d'une aide ménagère vs votre temps",category:"Économie",readTime:"10 min",publishedAt:"2024-01-05",author:"Jean Dupont",image:"/lovable-uploads/4a8ac677-6a3b-48a7-8b21-5c9953137147.png",content:`
    ...
    `},"selectionner-meilleure-garde-enfants":{title:"Sélectionner la meilleure garde d'enfants",category:"Parentalité",readTime:"15 min",publishedAt:"2024-01-01",author:"Claire Rousseau",image:"/lovable-uploads/1ac09068-74a1-4d44-bdc6-d342fcb10cd4.png",content:`
    ...
    `}},B=()=>{const{slug:s}=d(),i=s?A[s]:null;return i?e.jsxs("div",{className:"min-h-screen",children:[e.jsx(P,{}),e.jsx(c,{title:`${i.title} | Blog Bikawo`,description:`${i.title} - Découvrez nos conseils pour réduire la charge mentale et organiser votre quotidien familial.`,keywords:`${i.category.toLowerCase()}, charge mentale, ${i.title.toLowerCase()}, délégation, organisation familiale`,type:"article",publishedTime:i.publishedAt,author:i.author,structuredData:C({title:i.title,description:`${i.title} - Conseils pratiques pour un quotidien plus serein`,author:i.author,publishedAt:i.publishedAt,image:i.image,slug:s||""})}),e.jsx(o,{}),e.jsxs("div",{className:"pt-16 lg:pt-20",children:[e.jsx("section",{className:"py-16 bg-gradient-subtle",children:e.jsxs("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8",children:[e.jsx(l,{variant:"ghost",asChild:!0,className:"mb-6",children:e.jsxs(t,{to:"/blog",children:[e.jsx(g,{className:"w-4 h-4 mr-2"}),"Retour au blog"]})}),e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx(v,{variant:"secondary",children:i.category}),e.jsxs("div",{className:"flex items-center text-sm text-muted-foreground",children:[e.jsx(f,{className:"w-4 h-4 mr-1"}),i.readTime]})]}),e.jsx("h1",{className:"text-4xl md:text-5xl font-bold text-foreground leading-tight",children:i.title}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center text-sm text-muted-foreground",children:[e.jsx(x,{className:"w-4 h-4 mr-1"}),i.author,e.jsx(b,{className:"w-4 h-4 ml-4 mr-1"}),new Date(i.publishedAt).toLocaleDateString("fr-FR")]}),e.jsxs(l,{variant:"outline",size:"sm",children:[e.jsx(q,{className:"w-4 h-4 mr-2"}),"Partager"]})]})]})]})}),e.jsx("section",{className:"py-16",children:e.jsxs("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8",children:[e.jsx("div",{className:"aspect-video mb-12 overflow-hidden rounded-lg",children:e.jsx("img",{src:i.image,alt:i.title,className:"w-full h-full object-cover"})}),e.jsx("article",{className:"prose prose-lg max-w-none",children:e.jsx("div",{dangerouslySetInnerHTML:{__html:h.sanitize(i.content)}})})]})}),e.jsx("section",{className:"py-16 bg-muted/5",children:e.jsx("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8",children:e.jsxs(j,{className:"p-8 text-center",children:[e.jsx("h3",{className:"text-2xl font-bold text-foreground mb-4",children:"Prêt à simplifier votre quotidien ?"}),e.jsx("p",{className:"text-muted-foreground mb-6",children:"Découvrez nos services personnalisés et libérez-vous de la charge mentale"}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4 justify-center",children:[e.jsx(l,{asChild:!0,children:e.jsxs(t,{to:"/services",children:[e.jsx(z,{className:"w-4 h-4 mr-2"}),"Découvrir nos services"]})}),e.jsx(l,{variant:"outline",asChild:!0,children:e.jsx(t,{to:"/contact",children:"Demander un devis gratuit"})})]})]})})})]}),e.jsx(u,{})]}):e.jsxs("div",{className:"min-h-screen",children:[e.jsx(c,{title:"Article non trouvé | Bikawo",description:"L'article que vous cherchez n'existe pas ou a été supprimé."}),e.jsx(o,{}),e.jsx("div",{className:"pt-16 lg:pt-20 py-16",children:e.jsxs("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center",children:[e.jsx("h1",{className:"text-4xl font-bold text-foreground mb-4",children:"Article non trouvé"}),e.jsx("p",{className:"text-muted-foreground mb-8",children:"L'article que vous cherchez n'existe pas ou a été supprimé."}),e.jsx(l,{asChild:!0,children:e.jsx(t,{to:"/blog",children:"Retour au blog"})})]})}),e.jsx(u,{})]})};export{B as default};

...
-- Améliorer le trigger pour mettre à jour les heures à chaque booking complété
...
BEGIN
  ...
  -- TOUJOURS mettre à jour les heures dans la table referrals
  UPDATE public.referrals
  SET hours_completed = v_total_hours

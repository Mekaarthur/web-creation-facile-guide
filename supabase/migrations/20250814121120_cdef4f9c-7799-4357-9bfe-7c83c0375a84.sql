...
ADD COLUMN admin_user_id UUID DEFAULT NULL;
...
DROP POLICY IF EXISTS "Providers can view their mission assignments" ON missions;
DROP POLICY IF EXISTS "System can manage mission assignments" ON missions;
DROP POLICY IF EXISTS "Providers can insert their responses" ON candidatures_prestataires;
DROP POLICY IF EXISTS "Providers can view their responses" ON candidatures_prestataires;
DROP POLICY IF EXISTS "System can manage provider responses" ON candidatures_prestataires;

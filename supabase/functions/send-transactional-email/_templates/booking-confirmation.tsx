  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>? R�servation confirm�e</Heading>
        ...
        <Section style={urssafBox}>
          <Text style={urssafTitle}>💰 Crédit d'impôt 50%</Text>
          <Text style={urssafText}>
            Ce service est éligible au crédit d'impôt emploi à domicile.
            Conservez cet email et téléchargez votre attestation fiscale depuis
            votre espace personnel pour votre déclaration de revenus.
          </Text>
          <Text style={urssafFooter}>
            📄 Attestation disponible dans :<br />
            <strong>Mon compte → Attestations fiscales</strong>
          </Text>
        </Section>
